...
- **name-based seed classification** (body-classifier.ts:50-67) — NOT verified this session; flagged for a future fixture-based check (a seed-name → PDA misclassification would be a genuine compiles-but-wrong silent risk worth confirming).
