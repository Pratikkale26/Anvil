...
export function Hero({ overallSavings }: { overallSavings: string }) {
  ...
  return (
    <section className="anvil-container anvil-section text-center">
      <span className="inline-flex items-center gap-2 px-4 py-1 rounded-full border border-[rgba(245,166,35,0.25)] bg-[rgba(245,166,35,0.08)] text-[12px] font-semibold tracking-widest text-anvil-amber mb-7">
      ...
      <div className="mt-10 flex items-center justify-center gap-3 flex-wrap">
        <button
          ...
          className="inline-flex items-center gap-2 px-7 py-3 rounded-full text-[14px] font-bold cursor-pointer border-0 bg-linear-to-br from-[#f5a623] to-[#e8820a] text-[#0a0600] hover:opacity-95 transition-opacity"
        >
          Try the Compiler <ArrowRight size={15} />
        </button>
        <Link
          href="/workbench"
          className="inline-flex items-center gap-2 px-7 py-3 rounded-full text-[14px] font-bold no-underline bg-white/6 text-anvil-text-sub hover:text-anvil-text hover:bg-white/8 transition-colors"
        >
