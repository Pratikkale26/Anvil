...
const NEW_KIND_FIXTURES: Array<{
  ...
  {
    name: "cpi_mpl_core_add_plugin_v1 (task #48 S6)",
    stmt: {
      ...
      systemProgram: "system_program",
      logWrapper: "None",
      pluginVariant: "FreezeDelegate",
      pluginFrozen: "false",
    },
  },
  {
    name: "cpi_mpl_core_remove_plugin_v1 (task #48 S7)",
    stmt: {
  ...
  {
    name: "cpi_mpl_core_update_plugin_v1 (task #48 S8)",
    stmt: {
  ...
  {
    name: "cpi_mpl_core_approve_plugin_authority_v1 (task #48 S9)",
    stmt: {
  ...
  {
    name: "cpi_mpl_core_revoke_plugin_authority_v1 (task #48 S10)",
    stmt: {
