//! TokenVesting — generated by Anvil v0.4.0
...
pub const ID: Pubkey = Pubkey::new_from_array([7, 87, 23, 47, 219, 236, 238, 33, 137, 188, 215, 141, 32, 229, 155, 195, 133, 124, 23, 232, 113, 153, 252, 252, 111, 5, 187, 128, 0, 0, 0, 0]);
pub fn id() -> Pubkey { ID }
...
pub fn create_vesting(
    ...
    let mut vesting = Vesting { grantor: Pubkey::default(), beneficiary: Pubkey::default(), mint: Pubkey::default(), vault: Pubkey::default(), total_amount: 0, released_amount: 0, start_ts: 0, cliff_ts: 0, end_ts: 0, revocable: false, revoked: false, created_at: 0, bump: 0, vault_bump: 0 };
...
impl Vesting {
    ...
    pub fn read(data: &[u8]) -> Result<Self, ProgramError> {
        ...
        offset += 8;
        let revocable: bool = match __data_buf[offset] {
            0 => false,
            1 => true,
            _ => return Err(ProgramError::InvalidAccountData),
        };
        offset += 1;
        let revoked: bool = match __data_buf[offset] {
            0 => false,
            1 => true,
            _ => return Err(ProgramError::InvalidAccountData),
        };
    ...
    pub fn write(data: &mut [u8], value: &Self) -> ProgramResult {
        ...
        let mut offset = 8usize;
        __data_buf[offset..offset + 32].copy_from_slice(&value.grantor.as_ref());
        offset += 32;
        __data_buf[offset..offset + 32].copy_from_slice(&value.beneficiary.as_ref());
        offset += 32;
        __data_buf[offset..offset + 32].copy_from_slice(&value.mint.as_ref());
        offset += 32;
        __data_buf[offset..offset + 32].copy_from_slice(&value.vault.as_ref());
        offset += 32;
        __data_buf[offset..offset + 8].copy_from_slice(&value.total_amount.to_le_bytes());
        offset += 8;
        __data_buf[offset..offset + 8].copy_from_slice(&value.released_amount.to_le_bytes());
        offset += 8;
        __data_buf[offset..offset + 8].copy_from_slice(&value.start_ts.to_le_bytes());
        offset += 8;
        __data_buf[offset..offset + 8].copy_from_slice(&value.cliff_ts.to_le_bytes());
        offset += 8;
        __data_buf[offset..offset + 8].copy_from_slice(&value.end_ts.to_le_bytes());
        offset += 8;
        __data_buf[offset] = if value.revocable { 1 } else { 0 };
        offset += 1;
        __data_buf[offset] = if value.revoked { 1 } else { 0 };
        offset += 1;
        __data_buf[offset..offset + 8].copy_from_slice(&value.created_at.to_le_bytes());
        offset += 8;
