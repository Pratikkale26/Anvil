...
pub const ID: Pubkey = [3, 6, 110, 48, 78, 79, 9, 144, 11, 138, 67, 89, 110, 169, 249, 46, 36, 109, 196, 227, 247, 232, 72, 188, 198, 113, 187, 112, 0, 0, 0, 0];
pub fn id() -> Pubkey { ID }
...
pub fn initialize(
    ...
    let mut counter = CounterAccount { authority: [0u8; 32], count: 0, bump: 0 };
