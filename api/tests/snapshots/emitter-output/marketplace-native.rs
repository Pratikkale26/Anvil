//! Marketplace — generated by Anvil v0.4.0
...
pub const ID: Pubkey = Pubkey::new_from_array([5, 81, 60, 242, 104, 117, 240, 29, 21, 111, 218, 142, 52, 148, 81, 164, 40, 220, 125, 165, 225, 84, 185, 102, 118, 171, 190, 152, 0, 0, 0, 0]);
pub fn id() -> Pubkey { ID }
...
pub fn list(
    ...
    if *nft_mint.owner != Pubkey::new_from_array([6, 221, 246, 225, 215, 101, 161, 147, 217, 203, 225, 70, 206, 235, 121, 172, 28, 180, 133, 237, 95, 91, 55, 145, 58, 140, 245, 133, 126, 255, 0, 169]) {
        return Err(ProgramError::IncorrectProgramId);
    }
    if *seller_ata.owner != Pubkey::new_from_array([6, 221, 246, 225, 215, 101, 161, 147, 217, 203, 225, 70, 206, 235, 121, 172, 28, 180, 133, 237, 95, 91, 55, 145, 58, 140, 245, 133, 126, 255, 0, 169]) {
        return Err(ProgramError::IncorrectProgramId);
    }
...
impl Marketplace {
    ...
    pub fn write(data: &mut [u8], value: &Self) -> ProgramResult {
        ...
        offset += 2;
        __data_buf[offset..offset + 32].copy_from_slice(&value.treasury.as_ref());
        offset += 32;
...
impl Listing {
    ...
    pub fn write(data: &mut [u8], value: &Self) -> ProgramResult {
        ...
        let __data_buf: &mut [u8] = data;
        let mut offset = 8usize;
        __data_buf[offset..offset + 32].copy_from_slice(&value.seller.as_ref());
        offset += 32;
        ...
        __data_buf[offset] = value.bump as u8;
        offset += 1;
        __data_buf[offset..offset + 32].copy_from_slice(&value.marketplace.as_ref());
        offset += 32;
