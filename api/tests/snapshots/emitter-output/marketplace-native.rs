...
fn delist(
    ...
    let (expected_key, bump_listing) = Pubkey::find_program_address(&[b"listing", seller.key.as_ref(), &listing.seed.to_le_bytes()], program_id);
...
fn spl_token_close_account_signed<'a>(
    account: &AccountInfo<'a>,
