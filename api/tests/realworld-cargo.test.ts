...
const EXTERNAL_MUST_PASS: ExternalCase[] = [
  ...
  { id: "metaplex-anchor-nft", target: "pinocchio",
    ...
    maintainer: "anvil-core", lastPassedDate: "2026-05-24" },
  // anchor-crowdfund: ProgramResult unlocked but 2 errors remain (result scope + amount_donated field on AccountInfo)
  ...
  { id: "crowdfunding-solana", target: "pinocchio",
    ...
    maintainer: "anvil-core", lastPassedDate: "2026-05-24" },
  // crowdfunding-solana/native: 1 error (invoke type mismatch on &AccountInfo vs AccountInfo)
