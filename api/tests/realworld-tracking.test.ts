...
const TRACKED: TrackedCase[] = [
  ...
  },
  {
    ...
    source: "Squads-Protocol/squads-mpl (programs/roles)",
    maxErrors: 44,
    reason: "Down from 55 after sibling-crate fix (target-agnostic in base postProcessInstructionBody). Remaining: 7 E0433 in From<X> for squads_mpl::Y trait-impl bodies (whole impl needs commentout) + same AccountInfo field-access gap as pinocchio.",
    repo: "https://github.com/Squads-Protocol/squads-mpl",
    cloneRoot: "/tmp/squads-mpl",
  },
  {
