...
// #13 — T22 extension call-site comment-out subsystem extracted to its own
// module. The class's body-rewrite path calls these two; the public
// `applyT22ExtensionCommentout` entry point + `NATIVE_T22_*` blacklists now
// live there too, imported directly by native-emitter (no longer via here).
import { commentOutT22ExtensionCallSites, commentOutSolanaProgramInvoke } from "./t22-extension-commentout.js";
