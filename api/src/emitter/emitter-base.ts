...
// (`import { stripAnchorWrappersInCode } from "../emitter-base.js"`) still work.
import {
  commentOutSiblingStateAccesses,
  rewriteGetInstancePackedLen,
  rewriteRentSysvarMethods,
  rewriteTryIntoUnwrap,
  rewriteAnchorResultAlias,
  synthesizePhantomLifetimeFields,
  dropUnusedLifetimes,
  balanceLibBraces,
  stripAnchorLangPrefixes,
  addInfoLifetimeIfReferenced,
  collectCarriedFromImpls,
  stripScaffoldFromImpls,
  stripAnchorWrappersInCode,
  commentOutSiblingTraitImpl,
  rewriteSiblingCpiCalls,
  stubAnchorOnlyImplItem,
  // internal helpers (not re-exported — emitter-base is their only caller)
  extractUserDerives,
  stripAnchorWrapperTypes,
  computeT22ExtensionSpace,
} from "./carried-code-transforms.js";
export {
  commentOutSiblingStateAccesses,
  rewriteGetInstancePackedLen,
  rewriteRentSysvarMethods,
...
export abstract class BaseEmitter {
  ...
  private emitStateFile(ir: SolanaIR): string {
    ...
    sections.push(`//! Generated by Anvil v0.4.0 — Target: ${this.frameworkName}\n`);
...
${allFields}
  ...
  protected fileHeader(name: string): string {
    ...
    return `//! ${toPascalCase(name)} — generated by Anvil v0.4.0
